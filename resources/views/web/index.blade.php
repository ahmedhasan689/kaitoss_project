...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="{{ asset('web/assets/images/favicon.svg') }}" type="image/svg" />
            ...
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg">
                    <a class="navbar-brand" href="index.html">
                        <img src="{{ asset('web/assets/images/white-logo.svg') }}" alt="Logo" />
                    </a>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12 col-12">
                <div class="header-image">
                    <img src="{{ asset('web/assets/images/header/hero-image.jpg') }}" alt="#" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-12">
                <div class="about-image-five">
                    ...
                    <img src="{{ asset('web/assets/images/about/about-img1.jpg') }}" alt="about" />
                </div>
            </div>
            <div class="col-lg-6 col-12">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-news">
                    <div class="image">
                        <a href="javascript:void(0)"><img class="thumb" src="{{ asset('web/assets/images/blog/1.jpg') }}" alt="Blog" /></a>
                        <div class="meta-details">
                            <img class="thumb" src="{{ asset('web/assets/images/blog/b6.jpg') }}" alt="Author" />
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-news">
                    <div class="image">
                        <a href="javascript:void(0)"><img class="thumb" src="{{ asset('web/assets/images/blog/2.jpg') }}" alt="Blog" /></a>
                        <div class="meta-details">
                            <img class="thumb" src="{{ asset('web/assets/images/blog/b6.jpg') }}" alt="Author" />
                            <span>BY TIM NORTON</span>
                        </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-news">
                    <div class="image">
                        <a href="javascript:void(0)"><img class="thumb" src="{{ asset('web/assets/images/blog/3.jpg') }}" alt="Blog" /></a>
                        <div class="meta-details">
                            <img class="thumb" src="{{ asset('web/assets/images/blog/b6.jpg') }}" alt="Author" />
                            <span>BY TIM NORTON</span>
                        </div>
            ...
            <div class="col-xl-8">
                <div class="contact-form-wrapper">
                    ...
                    <form action="{{ route('contact-us.store') }}" method="POST" class="contact-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" class="@error('name') is-invalid @enderror" name="name" id="name" placeholder="Name" required />
                                @error('name')
                                    <div class="alert text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <input type="email" class="@error('email') is-invalid @enderror" name="email" id="email" placeholder="Email" required />
                                @error('email')
                                    <div class="alert text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" class="@error('phone_number') is-invalid @enderror" name="phone_number" id="phone" placeholder="Phone" required />
                                @error('phone_number')
                                    <div class="alert text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="@error('subject') is-invalid @enderror" name="subject" id="email" placeholder="Subject" required />
                                @error('subject')
                                    <div class="alert text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <textarea name="message" class="@error('message') is-invalid @enderror" id="message" placeholder="Type Message" rows="5"></textarea>
                                @error('message')
                                    <div class="alert text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-6 col-12">
                        ...
                        <div class="footer-widget f-about">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="{{ asset('web/assets/images/logo.svg') }}" alt="#" class="img-fluid" />
                                </a>
                            </div>
                            <p class=" text-white">
